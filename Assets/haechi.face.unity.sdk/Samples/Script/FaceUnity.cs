...
namespace haechi.face.unity.sdk.Samples.Script
{
    public class FaceUnity : MonoBehaviour
    {
        ...
        public async Task GetMainAccount()
        {
        ...
        public async void SendNativeCoinTransaction()
        {
            ...
            RawTransaction request = RawTransaction.Of(this.dataDesignator.loggedInAddress.text, this.inputDesignator.to.text,
        ...
        public async void SendErc20Transaction()
        {
            ...
            string data =
                this._face.dataFactory.CreateErc20SendData(this.inputDesignator.erc20TokenAddress.text, this.inputDesignator.erc20To.text, amount,
                    decimals);
        ...
        public async void GetErc20Balance()
        {
            ...
            RawTransaction request = RawTransaction.Of(null, this.inputDesignator.erc20BalanceInquiryAddress.text, "0x0", data);
        ...
        public async void SendErc721Transaction()
        {
            ...
            string data = this._face.dataFactory.CreateErc721SendData(this.inputDesignator.erc721NftAddress.text,
                this.dataDesignator.loggedInAddress.text, this.inputDesignator.erc721To.text, this.inputDesignator.erc721TokenId.text);
            RawTransaction request = RawTransaction.Of(this.dataDesignator.loggedInAddress.text, this.inputDesignator.erc721NftAddress.text,
                "0x0",
                data);
            FaceRpcResponse response = await this._face.wallet.SendTransaction(request);
        ...
        public async void SendErc1155Transaction()
        {
            ...
            string data = this._face.dataFactory.CreateErc1155SendBatchData(this.inputDesignator.erc1155NftAddress.text,
                this.dataDesignator.loggedInAddress.text, this.inputDesignator.erc1155To.text, this.inputDesignator.erc1155TokenId.text,
                this.inputDesignator.erc1155Quantity.text);
            RawTransaction request = RawTransaction.Of(this.dataDesignator.loggedInAddress.text, this.inputDesignator.erc1155NftAddress.text,
                "0x0",
                data);
            FaceRpcResponse response = await this._face.wallet.SendTransaction(request);
        ...
        {
            this.ValidateIsLoggedIn();
            string data = this._face.dataFactory.CreateErc20GetDecimalsData(this.inputDesignator.erc20TokenAddress.text);
