...
namespace haechi.face.unity.sdk.Samples.Script
{
    public class InputDesignator : MonoBehaviour
    {
        ...
        public TMP_InputField landscapeErc1155To, landscapeErc1155TokenId, landscapeErc1155Quantity, landscapeErc1155NftAddress;
        public TMP_InputField landscapeErc20To, landscapeErc20Amount, landscapeErc20TokenAddress, landscapeErc20BalanceInquiryAddress;
        ...
        private void Start()
        {
            ...
            this.blockchainDrd.onValueChanged.AddListener((value) => { SetDropdown(this.landscapeBlockchainDrd, value); });
            this.landscapeProfileDrd.onValueChanged.AddListener((value) => { SetDropdown(this.profileDrd, value); });
            this.landscapeBlockchainDrd.onValueChanged.AddListener((value) => { SetDropdown(this.blockchainDrd, value); });
            ...
            this.erc1155TokenId.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc1155TokenId, value); });
            this.erc1155Quantity.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc1155Quantity, value); });
            this.erc1155NftAddress.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc1155NftAddress, value); });
            ...
            this.erc20TokenAddress.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc20TokenAddress, value); });
            this.erc20BalanceInquiryAddress.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc20BalanceInquiryAddress, value); });
            this.erc721To.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc721To, value); });
            this.erc721TokenId.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc721TokenId, value); });
            this.erc721NftAddress.onValueChanged.AddListener((value) => { SetInputText(this.landscapeErc721NftAddress, value); });
            this.messageToSign.onValueChanged.AddListener((value) => { SetInputText(this.landscapeMessageToSign, value); });
            ...
            this.landscapeErc1155TokenId.onValueChanged.AddListener((value) => { SetInputText(this.erc1155TokenId, value); });
            this.landscapeErc1155Quantity.onValueChanged.AddListener((value) => { SetInputText(this.erc1155Quantity, value); });
            this.landscapeErc1155NftAddress.onValueChanged.AddListener((value) => { SetInputText(this.erc1155NftAddress, value); });
            ...
            this.landscapeErc20TokenAddress.onValueChanged.AddListener((value) => { SetInputText(this.erc20TokenAddress, value); });
            this.landscapeErc20BalanceInquiryAddress.onValueChanged.AddListener((value) => { SetInputText(this.erc20BalanceInquiryAddress, value); });
            this.landscapeErc721To.onValueChanged.AddListener((value) => { SetInputText(this.erc721To, value); });
            this.landscapeErc721TokenId.onValueChanged.AddListener((value) => { SetInputText(this.erc721TokenId, value); });
            this.landscapeErc721NftAddress.onValueChanged.AddListener((value) => { SetInputText(this.erc721NftAddress, value); });
            this.landscapeMessageToSign.onValueChanged.AddListener((value) => { SetInputText(this.messageToSign, value); });
        }
